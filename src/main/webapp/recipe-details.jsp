        ...
        <div class="border-dashed view-height w-100">
            <div class="mt-4 ml-4 mr-4">
                <div class="row border-bottom border-3">
                    ...
                    <div class="col d-flex justify-content-end mb-2"><a href="/app-recipeList"
                ...
                <table class="table borderless">
                    ...
                    <tr class="d-flex">
                        <th scope="row" class="col-2">
                            Przygotowanie (minuty)
                        </th>
                        <td class="col-7">
                            <c:out value="${recipe.preparationTime}"></c:out>
                        </td>
                    </tr>
                    </tbody>
                </table>
                ...
                <div class="row d-flex">
                    ...
                    <c:forEach items="${ingredients}" var="post">
                        <li>${post}</li>
